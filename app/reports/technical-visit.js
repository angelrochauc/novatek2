...
export default function TechnicalVisit() {
    ...
    const generateReport = () => {
        const newReport = {
            ...
            ducting,
            initialSystemState,
            otherInitialSystemState,
            equipmentList,
            materialList,
            photos,
            summary,
        };
        console.log("Generando reporte:", newReport);
    };
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Modal visible={addEquipmentModalVisible} animationType="slide" transparent={true}>
                <View style={styles.modal}>
                    <View style={{ width: "80%", backgroundColor: "#fff", padding: 20, borderRadius: 10 }}>
                        ...
                        <Pressable onPress={() => addEquipmentToList()} style={{ backgroundColor: "#208edb", padding: 10, borderRadius: 6, marginTop: 10 }}>
            ...
            <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
                ...
                <TextInput style={{ borderWidth: 1, borderColor: "#ccc", borderRadius: 8, padding: 10, marginTop: 8 }} keyboardType="numeric" value={equipmentToQuote} onChangeText={setEquipmentToQuote} />
                ...
                <Table
                    headers={[
                        { key: "equipment", title: "Equipo", width: "30%" },
                        { key: "quantity", title: "Cantidad", width: "25%" },
                        { key: "obs", title: "Observaciones", width: "45%" },
                    ]}
                    fullWidth={true}
                    data={equipmentList}
                ...
                <Table fullWidth={true} headers={[{ key: "photo", title: "Fotos", width: "100%" }]} data={[{ photo: "foto1.jpg" }, { photo: "foto2.jpg" }, { photo: "foto3.jpg" }]} headerBgColor="#F0F0F4"></Table>
